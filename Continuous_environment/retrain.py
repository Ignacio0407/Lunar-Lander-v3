...
epsilon = 0.3  # ✅ Less exploration (it already knows how to drive)
EPSILON_MIN = 0.1
EPSILON_DECAY = 0.998

EARLY_STOPPING_ENABLED = True
EARLY_STOPPING_THRESHOLD = 15 # ✅ More permissive.
EARLY_STOPPING_STARTING_EPISODE = 2250  # ✅ Evaluate before.
...
print(f"✅ Replay memory inicialized: {len(replay_memory)} transitions")
